...
const WazeIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={className}>
    <path
      fill="#33CCFF"
      d="M12 2C7.03 2 3 5.58 3 10c0 2.13 1.01 4.06 2.63 5.5C5.24 17.08 4.5 19 4.5 19s2.77-.8 4.5-1.88c.96.25 1.96.38 3 .38 4.97 0 9-3.58 9-8s-4.03-8-9-8zm-3 11a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm6 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"
    />
  </svg>
);
