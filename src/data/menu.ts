...
const sushiRolls: MenuItem[] = sushiRollsData.map((roll, i) => ({
  ...
  description_ru: 'Свежий ролл ручной работы из премиальных ингредиентов',
  price: 42,
  image: pickRollImg(i),
  tags: ['sushi', 'roll'],
  isAvailable: true,
...
const kitchenData = [
  { name: 'Asadoaki', name_he: 'אסאדואקי', name_ar: 'أسادواكي', name_ru: 'Асадоаки', desc: 'Grilled beef with Asian glaze', desc_he: 'בקר צלוי עם זיגוג אסייתי', desc_ar: 'لحم بقري مشوي مع تزجيج آسيوي', desc_ru: 'Жареная говядина с азиатской глазурью', price: 52, img: kitchenAsadoaki },
  { name: 'Crispy Salmon', name_he: 'סלמון קריספי', name_ar: 'سالمون مقرمش', name_ru: 'Хрустящий лосось', desc: 'Pan-seared crispy skin salmon', desc_he: 'סלמון עם עור פריך על המחבת', desc_ar: 'سالمون بقشرة مقرمشة', desc_ru: 'Лосось с хрустящей корочкой', price: 58, img: kitchenCrispySalmon },
  { name: 'Avocado Salad', name_he: 'סלט אבוקדו', name_ar: 'سلطة أفوكادو', name_ru: 'Салат с авокадо', desc: 'Fresh avocado with sesame dressing', desc_he: 'אבוקדו טרי עם רוטב שומשום', desc_ar: 'أفوكادو طازج مع صلصة السمسم', desc_ru: 'Свежее авокадо с кунжутной заправкой', price: 38, img: kitchenAvocadoSalad },
  { name: 'Beef Broccoli', name_he: 'בקר וברוקולי', name_ar: 'لحم بقري مع بروكلي', name_ru: 'Говядина с брокколи', desc: 'Wok-tossed beef with broccoli', desc_he: 'בקר מוקפץ בווק עם ברוקולי', desc_ar: 'لحم بقري مقلي مع بروكلي', desc_ru: 'Говядина с брокколи в воке', price: 48, img: kitchenBeefBroccoli },
  { name: 'Egg Roll', name_he: 'אגרול', name_ar: 'لفائف البيض', name_ru: 'Эгг ролл', desc: 'Crispy golden egg rolls', desc_he: 'אגרולים פריכים ומוזהבים', desc_ar: 'لفائف بيض ذهبية مقرمشة', desc_ru: 'Хрустящие золотистые яичные роллы', price: 28, img: kitchenEggRoll },
  { name: 'Crispy Shrimp Tempura', name_he: 'טמפורה שרימפס', name_ar: 'تمبورا الروبيان المقرمشة', name_ru: 'Темпура из креветок', desc: 'Lightly battered tempura shrimp', desc_he: 'שרימפס טמפורה קלה ופריכה', desc_ar: 'روبيان تمبورا خفيف ومقرمش', desc_ru: 'Креветки в лёгком кляре темпура', price: 45, img: kitchenShrimpTempura },
  { name: 'Chicken Popcorn', name_he: 'פופקורן עוף', name_ar: 'فشار الدجاج', name_ru: 'Попкорн из курицы', desc: 'Bite-sized crispy chicken', desc_he: 'חתיכות עוף פריכות בגודל ביס', desc_ar: 'قطع دجاج مقرمشة بحجم القضمة', desc_ru: 'Хрустящие кусочки курицы', price: 35, img: kitchenChickenPopcorn },
  { name: 'Chicken Bao', name_he: "באו צ'יקן", name_ar: 'باو الدجاج', name_ru: 'Бао с курицей', desc: 'Steamed bao with teriyaki chicken', desc_he: 'באו מאודה עם עוף טריאקי', desc_ar: 'باو مطهو على البخار مع دجاج ترياكي', desc_ru: 'Паровой бао с курицей терияки', price: 32, img: kitchenChickenBao },
  { name: 'Salmon Teriyaki', name_he: 'סלמון טריאקי', name_ar: 'سالمون ترياكي', name_ru: 'Лосось терияки', desc: 'Grilled salmon with teriyaki glaze', desc_he: 'סלמון צלוי עם זיגוג טריאקי', desc_ar: 'سالمون مشوي مع تزجيج ترياكي', desc_ru: 'Лосось на гриле с глазурью терияки', price: 56, img: kitchenSalmonTeriyaki },
];
